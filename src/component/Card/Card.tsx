...
function Card({image , date ,title ,contentshort , flex1 , width , btn1, btn2 , btn3 , id } : Article) {
...
const goToBlog = () =>{
  Navigate(`/blog/${id}`);
    ...
    return (
       <div className={` ${flex1 ? 'flex justify-between items-center md:flex-row flex-col ' : ''} ${width ? 'gap-x-6 w-[326px] md:w-[770px] lg:w-[592px]  ' : 'gap-x-8 lg:flex-row flex-col'}`} >
